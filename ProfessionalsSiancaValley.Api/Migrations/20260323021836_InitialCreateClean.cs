        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserPosition = table.Column<int>(type: "integer", nullable: false),
                    ...
                    TotalReportes = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Publications", x => x.Id_Publicacion);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MiniatureId_Miniature = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.MiniatureId_Miniature,
                        principalTable: "Miniatures",
                        principalColumn: "Id_Miniature");
                });
